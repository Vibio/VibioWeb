...
if ($profile_ext_user -> uid) {
	...
	$message = '<ul id="sign-in-btn" class="quicksand" ><li><a href="/user/register">REGISTER</a></li><li><a href="/user/login">SIGN IN</a></li><li><a href="/steps" class="works-modal">ABOUT</a></li></ul>';
}
